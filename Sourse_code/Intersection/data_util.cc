...
auto GenerateRandomDatabases(int64_t server_data_size, int64_t client_data_size,
    ...
    -> StatusOr<std::tuple<
        ...
        std::pair<std::vector<std::string>, std::vector<std::string>>, int64_t>> {
  // Check parameters
  ...
  std::vector<std::string> client_associated_values;
  Context context;
...
Status WriteClientDatasetToFile(
    ...
    const std::vector<std::string>& client_associated_values,
...
StatusOr<std::pair<std::vector<std::string>, std::vector<std::string>>>
